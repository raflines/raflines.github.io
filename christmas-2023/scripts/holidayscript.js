//FESTIVELY WATCHING SOMEONE PEE SIMULATOR (2023)
	...
	titleBGimg.src = "./games/fwsps_2023/title_1.png";

	//lose screen assets
	var loseBGnum = 1;

	var loseBGimg = new Image();
	loseBGimg.src = "./games/fwsps_2023/lose_1.png";

	//win screen assets
	var winBGimg = new Image();
	winBGimg.src = "./games/fwsps_2023/win.png";
	...
	var bathroomBGimg = new Image();
	bathroomBGimg.src = "./games/fwsps_2023/bathroom_1.png";

	var WatcherIMG = new Image();
	WatcherIMG.src = "./games/fwsps_2023/watcher_1.png";

	//general assets
	var christmasFrame = new Image();
	christmasFrame.src = "./games/fwsps_2023/christmas_frame.png";
	...
	var fwsps = {
		...
		setInterval( function() {
			...
			titleBGimg.src = "./games/fwsps_2023/title_" + titleBGnum + ".png";
		}, 1000 / 4)
		...
		setInterval( function() {
			...
			loseBGimg.src = "./games/fwsps_2023/lose_" + loseBGnum + ".png";
		}, 1000 / 4)
		...
		setInterval( function() {
			...
			if(percivalTick < 6){
				...
				bathroomBGimg.src = "./games/fwsps_2023/bathroom_2.png";
		...
		setInterval( function() {
			...
			if(playerWatcherNum == 1){
				...
				WatcherIMG.src = "./games/fwsps_2023/watcher_2.png";
				playerWatcherNum = 1;
			}
		}, 1000 / 3)
